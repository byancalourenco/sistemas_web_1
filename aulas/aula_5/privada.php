...
<html lang="pt-br">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Atividade PHP</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item  mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Portfolio</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <h1 class="masthead-heading text-uppercase mb-0">BEM VINDO (A) <?php echo $nome; ?></h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">SW 1 - BYANCA LOURENÇO - 2°C </p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">Freelancer é um tema bootstrap gratuito criado pela Start Bootstrap. O download inclui os arquivos de origem completos, incluindo HTML, CSS e JavaScript, bem como folhas de estilo SASS opcionais para fácil personalização.</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">Você pode criar seu próprio avatar personalizado para o cabeçalho, alterar o ícone nos divisores e adicionar seu endereço de e-mail ao formulário de contato para torná-lo totalmente funcional!</p></div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            Freelance é um tema Bootstrap gratuito e licenciado pelo MIT, criado por
                            <a href="http://startbootstrap.com">Iniciar Bootstrap</a>
                            .
                        </p>
                    </div>
                </div>
